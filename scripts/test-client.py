...
TOPIC_EXT_NTP_REQUEST = f'/ext/ntp/{PROJECT_ID}/3D24E79E3D7D4078B48440B528E7BF74/request'
TOPIC_EXT_NTP_RESPONSE = f'/ext/ntp/{PROJECT_ID}/3D24E79E3D7D4078B48440B528E7BF74/response'
...
async def main():
    ...
    async with Client(BROKER_ADDRESS) as client:
        ...
        async with client.messages() as messages:
            print("开始订阅消息...")
            await client.subscribe(DATA_TOPIC1)
