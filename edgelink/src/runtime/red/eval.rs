...
fn context_store_parser<'a>(
    input: &'a str,
) -> nom::IResult<&'a str, ParsedContextStoreProperty<'a>, nom::error::VerboseError<&str>> {
 ...
 */
pub fn parse_context_store<'a>(key: &'a str) -> crate::Result<ParsedContextStoreProperty<'a>> {
...
#[test]
fn parse_context_store_should_be_ok() {
